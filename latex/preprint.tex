...
Like the Koide formula---which relates lepton masses with remarkable precision without an accepted derivation---we present an unexplained numerical correlation: attractor periods of a discrete map on Gaussian integers modulo a prime are close to several Standard Model mass ratios.
